...
class OnboardingViewController: UIViewController {
    ...
    init(pages: [UIViewController] = [UIViewController](), viewOutput: OnboadringViewOutput) {
        self.pages = pages
...
private extension OnboardingViewController {
    func setupPageViewController() {
        ...
        // начинаем с первого екрана и идем анимрованно вперед
        pageViewController.setViewControllers(
            [pages.first!], direction: .forward, animated: true
        )
